...
public class DlgAuditCuciTanganMedis extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-05-2025" }));
        ...
        SebelumMenyentuh.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak", "N/A" }));
        SebelumMenyentuh.setName("SebelumMenyentuh"); // NOI18N
        SebelumMenyentuh.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SebelumMenyentuhActionPerformed(evt);
            }
        });
        ...
        SebelumTehnik.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak", "N/A" }));
        ...
        SetelahTerpapar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak", "N/A" }));
        ...
        SetelahKontak.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak", "N/A" }));
        ...
        SetelahLingkungan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak", "N/A" }));
    ...
    private void SebelumMenyentuhActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SebelumMenyentuhActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_SebelumMenyentuhActionPerformed
    ...
    private void tampil() {
        ...
        try{
            ...
            try {
                ...
                i=1;
                while(rs.next()){
                    sebelum_menyentuh_pasien=Double.parseDouble(rs.getString("sebelum_menyentuh_pasien").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("N/A","0"));
                    ttlsebelum_menyentuh_pasien=ttlsebelum_menyentuh_pasien+sebelum_menyentuh_pasien;
                    sebelum_tehnik_aseptik=Double.parseDouble(rs.getString("sebelum_tehnik_aseptik").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("N/A","0"));
                    ttlsebelum_tehnik_aseptik=ttlsebelum_tehnik_aseptik+sebelum_tehnik_aseptik;
                    setelah_terpapar_cairan_tubuh_pasien=Double.parseDouble(rs.getString("setelah_terpapar_cairan_tubuh_pasien").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("N/A","0"));
                    ttlsetelah_terpapar_cairan_tubuh_pasien=ttlsetelah_terpapar_cairan_tubuh_pasien+setelah_terpapar_cairan_tubuh_pasien;
                    setelah_kontak_dengan_pasien=Double.parseDouble(rs.getString("setelah_kontak_dengan_pasien").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("N/A","0"));
                    ttlsetelah_kontak_dengan_pasien=ttlsetelah_kontak_dengan_pasien+setelah_kontak_dengan_pasien;
                    setelah_kontak_dengan_lingkungan_pasien=Double.parseDouble(rs.getString("setelah_kontak_dengan_lingkungan_pasien").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("N/A","0"));
                ...
                if(i>0){
                    ...
                    tabMode.addRow(new String[]{
                        "","N/A",":",""+(i-ttlsebelum_menyentuh_pasien),""+(i-ttlsebelum_tehnik_aseptik),""+(i-ttlsetelah_terpapar_cairan_tubuh_pasien),
                        ""+(i-ttlsetelah_kontak_dengan_pasien),""+(i-ttlsetelah_kontak_dengan_lingkungan_pasien),""+((i-ttlsebelum_menyentuh_pasien)+(i-ttlsebelum_tehnik_aseptik)+
                        (i-ttlsetelah_terpapar_cairan_tubuh_pasien)+(i-ttlsetelah_kontak_dengan_pasien)+(i-ttlsetelah_kontak_dengan_lingkungan_pasien))
                    });
                    tabMode.addRow(new String[]{
