...
public class DlgAuditFasilitasAPD extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Audit1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak", "N/A" }));
        ...
        Audit2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak", "N/A" }));
        ...
        Audit3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak", "N/A" }));
        ...
        Audit4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak", "N/A" }));
        ...
        Audit5.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak", "N/A" }));
        ...
        Audit6.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak", "N/A" }));
    ...
    private void tampil() {
        ...
        try{
            ...
            try {
                ...
                i=1;
                while(rs.next()){
                    audit1=Double.parseDouble(rs.getString("audit1").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("N/A","0"));
                    ttlaudit1=ttlaudit1+audit1;
                    audit2=Double.parseDouble(rs.getString("audit2").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("N/A","0"));
                    ttlaudit2=ttlaudit2+audit2;
                    audit3=Double.parseDouble(rs.getString("audit3").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("N/A","0"));
                    ttlaudit3=ttlaudit3+audit3;
                    audit4=Double.parseDouble(rs.getString("audit4").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("N/A","0"));
                    ttlaudit4=ttlaudit4+audit4;
                    audit5=Double.parseDouble(rs.getString("audit5").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("N/A","0"));
                    ttlaudit5=ttlaudit5+audit5;
                    audit6=Double.parseDouble(rs.getString("audit6").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("N/A","0"));
                ...
                if(i>0){
                    ...
                    tabMode.addRow(new String[]{
                        "","N/A",":",""+(i-ttlaudit1),""+(i-ttlaudit2),""+(i-ttlaudit3),
                        ""+(i-ttlaudit4),""+(i-ttlaudit5),""+(i-ttlaudit6),""+((i-ttlaudit1)+(i-ttlaudit2)+
                        (i-ttlaudit3)+(i-ttlaudit4)+(i-ttlaudit5)+(i-ttlaudit6))
                    });
                    tabMode.addRow(new String[]{
