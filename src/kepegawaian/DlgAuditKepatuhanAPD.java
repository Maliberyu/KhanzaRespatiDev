...
public class DlgAuditKepatuhanAPD extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Topi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak", "N/A" }));
        ...
        Masker.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak", "N/A" }));
        ...
        KacaMata.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak", "N/A" }));
        ...
        SarungTangan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak", "N/A" }));
        ...
        Apron.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak", "N/A" }));
        ...
        Sepatu.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak", "N/A" }));
    ...
    private void tampil() {
        ...
        try{
            ...
            try {
                ...
                i=1;
                while(rs.next()){
                    topi=Double.parseDouble(rs.getString("topi").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("N/A","0"));
                    ttltopi=ttltopi+topi;
                    masker=Double.parseDouble(rs.getString("masker").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("N/A","0"));
                    ttlmasker=ttlmasker+masker;
                    kacamata=Double.parseDouble(rs.getString("kacamata").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("N/A","0"));
                    ttlkacamata=ttlkacamata+kacamata;
                    sarungtangan=Double.parseDouble(rs.getString("sarungtangan").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("N/A","0"));
                    ttlsarungtangan=ttlsarungtangan+sarungtangan;
                    apron=Double.parseDouble(rs.getString("apron").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("N/A","0"));
                    ttlapron=ttlapron+apron;
                    sepatu=Double.parseDouble(rs.getString("sepatu").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("N/A","0"));
                ...
                if(i>0){
                    ...
                    tabMode.addRow(new String[]{
                     ...
                     tabMode.addRow(new String[]{
                        "","N/A ",":","","",""+(i-ttltopi),""+(i-ttlmasker),""+(i-ttlkacamata),""+(i-ttlsarungtangan),""+(i-ttlapron),""+(i-ttlsepatu),
                        ""+((i-ttltopi)+(i-ttlmasker)+(i-ttlkacamata)+(i-ttlsarungtangan)+(i-ttlapron)+(i-ttlsepatu))
                    });
                    tabMode.addRow(new String[]{
