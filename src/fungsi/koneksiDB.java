    ...
    public static Connection condb(){ 
        if(connection == null){
            try{
                ...
                System.out.println("  Koneksi Berhasil. Sorry bro loading, karna butuh prosess yahh.... \n"+
                                   "  SEMAKIN BANYAK PENGETAHUAN SEMAKIN RENDAH EGO, SEMAKIN RENDAH PENGETAHUAN SEMAKIN TINGGI EGO\n" +  
                                   "  'ALBERT EINSTEIN'  \n\n"+
                         "  -----------------------------------------------------------------------------------------------------\n"+
                       
                        " -------------------------------------------------------------------------------------------------------------\n"+        
                        "  『KEBODOHAN ADALAH PENYAKIT YANG PALING MEMATIKAN, KARNA PENDERITANYA TIDAK SADAR SEDANG SAKIT』 -Socrates\n"+
                        "  ---------------------------------------------------------------------------------------------------------- \n"+
                        "  『BERFIKIR ITU SULIT, ITULAH MENGAPA KEBANYAKAN ORANG LEBIH SUKA MENILAI』 -Carl Gustav Jung\n"+
                        "  ------------------------------------------------------------------------------------------------ \n"+
                        "  『JIKA KAMU BENCI SESEORANG, SEBENARNYA KAMU SUDAH KALAH DARINYA』 -Confucius\n"+
                        "  ------------------------------------------------------------------------------------------------ \n"+
                        "  『DIA YANG BERTANYA AKAN KELIHATAN BODOH SELAMA 5 MENIT, DIA YANG TIDAK BERTANYA AKAN BODOH SELAMNYA』 -Immanuel Kant\n"+
                        "  ------------------------------------------------------------------------------------------------ \n"+
                        "  『NAIKAN LEVEL KATA KATAMU BUKAN NADA SUARAMU, HUJANLAH YANG MEMBUAT BUNGA MEKAR BUKAN PETIR』 -Jalaludin rumi\n"+
                        "  ------------------------------------------------------------------------------------------------ \n"+
                        "  『PUNCAK DARI KETINGGIAN ADAB ADALAH DIAM KETIKA MENDENGAN SESEORANG BERBICARA KEPADAMU \n"+
                        "    TENTANG SESUATU YANG ENGKAU KETAHUI DENGAN FASIH SEMENTARA DIA TIDAK MENGUASAINYA』 -Ibnu Khaldun\n"+
                        "  ------------------------------------------------------------------------------------------------ \n"+
    ...
    //konfig wa
     public static String TOKENWA() {
      ...
      public static String URLWEBAPPS() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database-extra.xml"));
            var = EnkripsiAES.decrypt(prop.getProperty("192.168.0.69/webapps24-05-23/"));
        } catch (Exception e) {
            var = "";
        }
        return var;
