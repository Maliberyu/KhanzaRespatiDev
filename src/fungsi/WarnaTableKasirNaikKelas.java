 ...
 * @author Owner
 */
public class WarnaTableKasirNaikKelas extends DefaultTableCellRenderer {
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column){
        Component component = super.getTableCellRendererComponent(table, value, isSelected, hasFocus, row, column);
         if (row % 2 == 1){
            component.setBackground(new Color(230,240,255));
        ...
        if(table.getValueAt(row,16).toString().equals("Pindah Kamar")){
            component.setBackground(new Color(200,0,0));
            component.setForeground(new Color(51,255,189));
//        }else if(table.getValueAt(row,10).toString().equals("Batal")){
...
//            component.setForeground(new Color(245,255,245));
////            }else if(table.getValueAt(row,10).toString().equals("Sudah Periksa")){
////            component.setBackground(new Color(119,221,119));
////            component.setForeground(new Color(245,255,245));
        }
