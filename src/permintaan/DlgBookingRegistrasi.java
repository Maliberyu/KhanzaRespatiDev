...
public class DlgBookingRegistrasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnKirimWA.setForeground(new java.awt.Color(51, 51, 51));
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-07-2024" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-07-2024" }));
        ...
        TanggalBooking.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-07-2024 08:45:50" }));
        ...
        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-07-2024 08:45:50" }));
        ...
        TPesan.setBackground(new java.awt.Color(255, 255, 255));
        TPesan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/whatsapp.png"))); // NOI18N
        TPesan.setText("Whatsapp");
        ...
        TPesan.setBounds(740, 100, 140, 22);
        ...
        for(i=0;i<tbObat.getRowCount();i++){
            if(tbObat.getValueAt(i,0).toString().equals("true") && !tbObat.getValueAt(i,27).toString().equals("Terkirim") ){
                try {
                    ...
                    headers.add("Authorization","ojLU1Sc4j5W9mXsQXZt1");
                    ...
                    // Pastikan tbObat.getValueAt(i, 5).toString() mengembalikan tanggal dalam format yang benar
                    String tanggalPeriksa = tbObat.getValueAt(i, 5).toString();

                    // Buat query SQL dengan interval 1 hari menggunakan date_sub
                        String query = "SELECT DATE_SUB('" + tanggalPeriksa + "', INTERVAL 1 DAY)";

                    // Lakukan query ke database
//                    String kirim = Sequel.cariIsi(query);
...
if(TPasien.getText().trim().equals("")&&TPasien.getText().trim().equals("")){
            ...
            kirim.setNoRm(TNoRM.getText(),NoReg.getText(),KdPoli.getText(),KdDokter.getText(),TanggalBooking.getDate());
...
//        tampil();
    ...
    private void TPesanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TPesanActionPerformed
        ...
        if(TPasien.getText().trim().equals("")&&TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            WhatsappKirimFonnte kirim=new WhatsappKirimFonnte(null,false); 
            kirim.setNoRm(TNoRM.getText(),NoReg.getText(),NmPoli.getText(),NmDokter.getText(), TanggalPeriksa.getDate());
            kirim.setSize(720,330);
            kirim.setLocationRelativeTo(internalFrame1);
            kirim.setVisible(true);
            this.setCursor(Cursor.getDefaultCursor());
