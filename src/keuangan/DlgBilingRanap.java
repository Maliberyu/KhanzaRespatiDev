        ...
        if(TNoRw.getText().trim().isEmpty()||TNoRM.getText().trim().isEmpty()||TPasien.getText().trim().isEmpty()){
            ...
            try{
                ...
                //    
                                    String dokter_anak = "";
                       try {
                           dokter_anak = Sequel.cariIsi("select dokter.nm_dokter from reg_periksa " +
                                                       "inner join dokter on reg_periksa.kd_dokter=dokter.kd_dokter " +
                                                       "where reg_periksa.no_rawat=? and dokter.kd_sps='ANA'", TNoRw.getText());
                           if(dokter_anak == null) {
                               dokter_anak = "";
                           }
                       } catch (Exception e) {
...
//                    //
                ...
                if(i>0){                       
                    ...
                    "&ttl="+ttl+
                    "&tanggal="+DTPTgl.getSelectedItem().toString().replaceAll(" ","_")+
                    "&dokter_anak="+dokter_anak.replaceAll(" ","_")+
