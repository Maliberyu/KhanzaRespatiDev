...
public class DlgRBTindakanKamar extends javax.swing.JDialog {
    ...
    private String pilihancarabayar="",nosep="";
    ...
    public DlgRBTindakanKamar(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"No.","Bangsal","Tgl.Masuk","Tgl.Keluar","Cara Bayar","Obt+Emb+Tsl","Laborat","Paket Tindakan","Tambahan","Potongan","Registrasi","Radiologi","Kamar","Total","SEP"};
...
//                                 tabMode.getValueAt(r,13).toString().replaceAll("'","`")+"','"+
    ...
    private void BtnAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAllActionPerformed
        ...
        pilihancarabayar="";
//        nosep="";
//        nosep = sequel.cariIsi("select no_sep from tabel bridging_sep where no_rawat=?", .getstring("no_rawat"));
        prosesCari();
                ...
                while(rsbangsal.next()){
                    ...
                    try {
                        ...
                        while(rspasien.next()){
                            ...
                            nosep = Sequel.cariIsi("select no_sep from bridging_sep where no_rawat=?", rspasien.getString("no_rawat"));
                            tabMode.addRow(new Object[]{
                                ...
                                Valid.SetAngka(radiologi),Valid.SetAngka(kamar),Valid.SetAngka(obat+obatlangsung+laborat+
                                        detaillaborat+jm+jm2+jm3+operasi+tambahan-potongan+registrasi+radiologi+kamar),nosep
                            });
                            a++;
                        }
                    } catch (Exception e) {
