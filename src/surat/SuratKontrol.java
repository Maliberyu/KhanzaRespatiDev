...
public class SuratKontrol extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-06-2024 11:23:52" }));
        ...
        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-06-2024 11:23:53" }));
        ...
        TPesan.setBackground(new java.awt.Color(102, 102, 102));
        ...
        TPesan.setBounds(760, 160, 120, 22);
  ...
  isForm();                
    ...
    private void TPesanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TPesanActionPerformed
        ...
        if(TPasien.getText().trim().equals("")&&TPasien.getText().trim().equals("")){
            ...
            kirim.setNoRm(TNoRM.getText(),TPasien.getText(),NmPoli.getText(),NmDokter.getText(),TanggalPeriksa.getDate());
