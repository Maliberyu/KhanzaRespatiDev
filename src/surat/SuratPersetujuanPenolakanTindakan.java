...
public final class SuratPersetujuanPenolakanTindakan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TglPernyataan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-06-2023" }));
        ...
        TglLahirPenerima.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-06-2023" }));
        ...
        TglLahirPenerima.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                TglLahirPenerimaItemStateChanged(evt);
            }
        });
    ...
    private void TglLahirPenerimaItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_TglLahirPenerimaItemStateChanged
        lahir = TglLahirPenerima.getDate();
        birthday = lahir.toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
        p = Period.between(birthday,today);
        UmurPenerima.setText(String.valueOf(p.getYears()));
    }//GEN-LAST:event_TglLahirPenerimaItemStateChanged
