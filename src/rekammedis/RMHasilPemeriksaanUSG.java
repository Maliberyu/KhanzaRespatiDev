...
public final class RMHasilPemeriksaanUSG extends javax.swing.JDialog {
    ...
    public RMHasilPemeriksaanUSG(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Peluang Sex","Indeks Cairan Ketuban (ICK)","Kelainan Kongenital Mayor","Jumlah Janin","FM","FHR","Ket Kembar","Kesimpulan"
        }){
...
//        KirimanDari.setDocument(new batasInput((int)50).getKata(KirimanDari));
        ...
        FM.setDocument(new batasInput((int)10).getKata(FM));
        FHR.setDocument(new batasInput((int)10).getKata(FHR));
        KetKembar.setDocument(new batasInput((int)1000).getKata(KetKembar));
...
//            TANGGALMUNDUR="yes";
    ...
    private void initComponents() {
        ...
        JumlahAirKetuban = new widget.ComboBox();
        jLabel45 = new widget.Label();
        scrollPane18 = new widget.ScrollPane();
        jLabel46 = new widget.Label();
        scrollPane19 = new widget.ScrollPane();
        KetKembar = new widget.TextArea();
        FM = new widget.TextBox();
        jLabel130 = new widget.Label();
        jLabel128 = new widget.Label();
        FHR = new widget.TextBox();
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(750, 473));
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "16-12-2024 14:11:53" }));
        ...
        jLabel31.setBounds(10, 110, 70, 23);
        ...
        jLabel35.setText("Jenis Presentasi :");
        ...
        PanjangFemur.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PanjangFemurActionPerformed(evt);
            }
        });
        ...
        PanjangFemur.setBounds(170, 170, 60, 23);
        ...
        KirimanDari.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Poli Obgyn", "IGD", "VK", "Rawat Inap" }));
        ...
        KirimanDari.setBounds(90, 80, 180, 23);
        ...
        PeluangSex.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Laki-laki", "Perempuan", "Tidak Tampak" }));
        ...
        PeluangSex.setBounds(620, 230, 105, 23);

        jLabel44.setText("Kesimpulan :");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput.add(jLabel44);
        jLabel44.setBounds(0, 400, 165, 23);
        ...
        scrollPane17.setBounds(170, 400, 555, 63);

        JumlahAirKetuban.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Kurang", "Banyak", "Cukup" }));
        JumlahAirKetuban.setName("JumlahAirKetuban"); // NOI18N
        JumlahAirKetuban.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JumlahAirKetubanActionPerformed(evt);
            }
        });
        ...
        JumlahAirKetuban.setBounds(390, 230, 105, 20);

        jLabel45.setText("Kesimpulan :");
        jLabel45.setName("jLabel45"); // NOI18N
        FormInput.add(jLabel45);
        jLabel45.setBounds(0, 400, 165, 23);
        ...
        scrollPane18.setBounds(170, 400, 555, 63);

        jLabel46.setText("Ket Kembar :");
        jLabel46.setName("jLabel46"); // NOI18N
        FormInput.add(jLabel46);
        jLabel46.setBounds(0, 320, 165, 23);
        ...
        KetKembar.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        KetKembar.setColumns(20);
        KetKembar.setRows(5);
        KetKembar.setName("KetKembar"); // NOI18N
        KetKembar.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KetKembarKeyPressed(evt);
            }
        });
        scrollPane19.setViewportView(KetKembar);

        FormInput.add(scrollPane19);
        scrollPane19.setBounds(170, 320, 555, 63);

        FM.setFocusTraversalPolicyProvider(true);
        FM.setName("FM"); // NOI18N
        ...
        FormInput.add(FM);
        FM.setBounds(340, 290, 60, 24);

        jLabel130.setText("FM :");
        jLabel130.setName("jLabel130"); // NOI18N
        FormInput.add(jLabel130);
        jLabel130.setBounds(310, 290, 30, 23);

        jLabel128.setText("FHR :");
        jLabel128.setName("jLabel128"); // NOI18N
        FormInput.add(jLabel128);
        jLabel128.setBounds(400, 290, 30, 23);

        FHR.setFocusTraversalPolicyProvider(true);
        FHR.setName("FHR"); // NOI18N
        FHR.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                FHRActionPerformed(evt);
            }
        });
        FHR.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                FHRKeyPressed(evt);
            }
        });
        FormInput.add(FHR);
        FHR.setBounds(430, 290, 60, 24);

        jLabel129.setText("Jumlah Janin :");
        jLabel129.setName("jLabel129"); // NOI18N
        FormInput.add(jLabel129);
        jLabel129.setBounds(90, 290, 80, 23);

        JumlahJanin.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tunggal", "Kembar" }));
        ...
        JumlahJanin.setBounds(180, 290, 105, 23);
...
//                            if(Sequel.cekTanggalRegistrasi(TanggalRegistrasi.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Tanggal.getSelectedItem().toString().substring(11,19))==true)
                ...
                htmlContent.append(                             
                    "<tr class='isi'>"+
                        ...
                        "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Kelainan Kongenital Mayor</b></td>"+
                             ...
                             "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Jumlah Janin</b></td>"+
                             "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>FM</b></td>"+
                             "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>FHR</b></td>"+
                             "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Ket Kembar</b></td>"+
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakHasilPemeriksaanUSG.jasper","report","::[ Formulir Hasil Pemeriksaan USG ]::",
                ...
                "hasil_pemeriksaan_usg.indek_cairan_ketuban,hasil_pemeriksaan_usg.kelainan_kongenital,hasil_pemeriksaan_usg.peluang_sex,hasil_pemeriksaan_usg.jumlah_janin,hasil_pemeriksaan_usg.fm,hasil_pemeriksaan_usg.fhr,hasil_pemeriksaan_usg.ket_kembar,"+
    ...
    private void DerajatMaturitasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DerajatMaturitasKeyPressed
        Valid.pindah(evt,Plasenta,KirimanDari);
    ...
    private void PeluangSexKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PeluangSexKeyPressed
        Valid.pindah(evt,KirimanDari,IndexCairan);
    ...
    private void PanjangFemurActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PanjangFemurActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_PanjangFemurActionPerformed

    private void JumlahAirKetubanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JumlahAirKetubanActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_JumlahAirKetubanActionPerformed
    ...
    private void KetKembarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KetKembarKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_KetKembarKeyPressed
    ...
    private void FHRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FHRActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_FHRActionPerformed

    private void FHRKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_FHRKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_FHRKeyPressed
    ...
    */
    ...
    private widget.TextBox FHR;
    private widget.TextBox FM;
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("plasenta_berimplatansi"),rs.getString("derajat_maturitas"),rs.getString("jumlah_air_ketuban"),rs.getString("peluang_sex"),
                       
                        rs.getString("indek_cairan_ketuban"),
                        rs.getString("kelainan_kongenital"),
                    
                         rs.getString("jumlah_janin"),//tambahan
                          rs.getString("fm"),//tambahan
                           rs.getString("fhr"),//tambahan
                            rs.getString("ket_kembar"),//tambahan
    ...
    public void emptTeks() {
        KirimanDari.setSelectedIndex(0);
        ...
        FM.setText("");
                FHR.setText("");
                        KetKembar.setText("");
        JumlahJanin.setSelectedIndex(0);// tambah
        DerajatMaturitas.setSelectedIndex(0);
        JumlahAirKetuban.setSelectedIndex(0);
...
//        KirimanDari.requestFocus();
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            KirimanDari.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),21).toString());
            ...
            JumlahAirKetuban.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),20).toString());
...
//            Kesimpulan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),24).toString());
                JumlahJanin.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),24).toString());//tambah
                    FM.setText(tbObat.getValueAt(tbObat.getSelectedRow(),25).toString());//tambah
                        FHR.setText(tbObat.getValueAt(tbObat.getSelectedRow(),26).toString());//tambah
                            KetKembar.setText(tbObat.getValueAt(tbObat.getSelectedRow(),27).toString());//tambah
...
// private void ganti() {
//    // Pastikan jumlah parameter yang Anda kirim sesuai dengan jumlah kolom yang akan diupdate
...
//        "jenis_prestasi=?,diameter_biparietal=?,panjang_femur=?,lingkar_abdomen=?,tafsiran_berat_janin=?,usia_kehamilan=?," +
//        "plasenta_berimplatansi=?,derajat_maturitas=?,jumlah_air_ketuban=?,indek_cairan_ketuban=?,kelainan_kongenital=?," +
//        "peluang_sex=?,jumlah_janin=?,fm=?,fhr=?,ket_kembar=?,kesimpulan=?", 26, new String[]{
//            TNoRw.getText(),
//            Valid.SetTgl(Tanggal.getSelectedItem() + "") + " " + Tanggal.getSelectedItem().toString().substring(11, 19),
//            KdDokter.getText(),
//            DiagnosaKlinis.getText(),
//            KirimanDari.getSelectedItem().toString(),
//            HTA.getText(),
...
//            JumlahAirKetuban.getSelectedItem().toString(),
//            IndexCairan.getText(),
//            Kelainan.getText(),
//            PeluangSex.getSelectedItem().toString(),
//            JumlahJanin.getSelectedItem().toString(),
//            FM.getText(),
//            FHR.getText(),   // Pastikan FHR.getText() memiliki nilai yang valid (tidak kosong)
//            KetKembar.getText(),
//            Kesimpulan.getText(),
//            tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString()
//        }) == true) {
//
//        // Update table UI after the update
...
//        tbObat.setValueAt(KirimanDari.getSelectedItem(), tbObat.getSelectedRow(), 7);
...
//        tbObat.setValueAt(JumlahAirKetuban.getSelectedItem().toString(), tbObat.getSelectedRow(), 20);
//        tbObat.setValueAt(PeluangSex.getSelectedItem().toString(), tbObat.getSelectedRow(), 21); //tambah
...
//        tbObat.setValueAt(JumlahJanin.getSelectedItem().toString(), tbObat.getSelectedRow(), 24);
//        tbObat.setValueAt(FM.getText(), tbObat.getSelectedRow(), 25);
//        tbObat.setValueAt(FHR.getText(), tbObat.getSelectedRow(), 26); // Pastikan FHR tidak null atau kosong
//        tbObat.setValueAt(KetKembar.getText(), tbObat.getSelectedRow(), 27);
//        tbObat.setValueAt(Kesimpulan.getText(), tbObat.getSelectedRow(), 28);
//
//        // Clear text fields and move to another tab
//        emptTeks();
//        TabRawat.setSelectedIndex(1);
//    }
//}
    ...
    private void ganti() {
        if(Sequel.mengedittf("hasil_pemeriksaan_usg","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,diagnosa_klinis=?,kiriman_dari=?,hta=?,kantong_gestasi=?,ukuran_bokongkepala=?,"+
                ...
                "jumlah_air_ketuban=?,indek_cairan_ketuban=?,kelainan_kongenital=?,peluang_sex=?,jumlah_janin=?,fm=?,fhr=?,ket_kembar,kesimpulan=?",25,new String[]{
                TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Tanggal.getSelectedItem().toString().substring(11,19),KdDokter.getText(),
                DiagnosaKlinis.getText(),KirimanDari.getSelectedItem().toString(),HTA.getText(),UkuranKantong.getText(),UkuranBokong.getText(),JenisPrestasi.getText(),
                DiameterBiparietal.getText(),PanjangFemur.getText(),LingkarAbdomen.getText(),TafsiranBerat.getText(),UsiaKehamilan.getText(),
                Plasenta.getText(),DerajatMaturitas.getSelectedItem().toString(),JumlahAirKetuban.getSelectedItem().toString(),IndexCairan.getText(),
                Kelainan.getText(),PeluangSex.getSelectedItem().toString(),
              
               JumlahJanin.getSelectedItem().toString(),FM.getText(),FHR.getText(),KetKembar.getText()//tabahan
                        ,Kesimpulan.getText(),
                tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
            })==true){
                tbObat.setValueAt(TNoRw.getText(),tbObat.getSelectedRow(),0);
                ...
                tbObat.setValueAt(Kelainan.getText(),tbObat.getSelectedRow(),23);
                 ...
                 tbObat.setValueAt(JumlahJanin.getSelectedItem().toString(),tbObat.getSelectedRow(),24);
                  tbObat.setValueAt(FM.getText(),tbObat.getSelectedRow(),25);
                   tbObat.setValueAt(FHR.getText(),tbObat.getSelectedRow(),26);
                    tbObat.setValueAt(KetKembar.getText(),tbObat.getSelectedRow(),27);
                    tbObat.setValueAt(Kesimpulan.getText(),tbObat.getSelectedRow(),28);
//                  
                emptTeks();
    ...
    private void simpan() {
        if(Sequel.menyimpantf("hasil_pemeriksaan_usg","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",25,new String[]{
                ...
                tabMode.addRow(new String[]{
                    ...
                    KirimanDari.getSelectedItem().toString(),DiagnosaKlinis.getText(),HTA.getText(),JenisPrestasi.getText(),UkuranKantong.getText(),UkuranBokong.getText(),DiameterBiparietal.getText(),PanjangFemur.getText(),LingkarAbdomen.getText(),
                    TafsiranBerat.getText(),UsiaKehamilan.getText(),Plasenta.getText(),DerajatMaturitas.getSelectedItem().toString(),JumlahAirKetuban.getSelectedItem().toString(),
                    PeluangSex.getSelectedItem().toString(),
                
                    IndexCairan.getText(),Kelainan.getText()
                        ,    JumlahJanin.getSelectedItem().toString(),FM.getText(),FHR.getText(),KetKembar.getText()//tambahan
                        ,Kesimpulan.getText()
                });
                emptTeks();
                LCount.setText(""+tabMode.getRowCount());
