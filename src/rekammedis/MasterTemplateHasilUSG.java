...
public class MasterTemplateHasilUSG extends javax.swing.JDialog {
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Nm.getText().trim().equals("")){
            ...
            if(Valid.hapusTabletf(tabMode,Kd,"template_hasil_usg","no_template")==true){
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(Kd.getText().trim().equals("")){
            ...
            if(Valid.editTabletf(tabMode,"template_hasil_usg","no_template","?","no_template=?,nama_pemeriksaan=?,template_hasil_usg=?",4,new String[]{
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Kd.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("template_hasil_usg","?,?,?","No.Template",3,new String[]{
...
*/
    ...
    */
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    "select template_hasil_usg.no_template,template_hasil_usg.nama_pemeriksaan, "+
                    "template_hasil_usg.template_hasil_usg from template_hasil_usg "+
                    "where template_hasil_usg.no_template like ? or template_hasil_usg.nama_pemeriksaan like ? or "+
                    "template_hasil_usg.template_hasil_usg like ? order by template_hasil_usg.no_template");
            try {
    ...
    public void emptTeks() {
        ...
        Nm.setText("");
        Template.setText("");
        Valid.autoNomer("template_hasil_usg","R",4,Kd);
        TabRawat.setSelectedIndex(0);
        Kd.requestFocus();
    }
