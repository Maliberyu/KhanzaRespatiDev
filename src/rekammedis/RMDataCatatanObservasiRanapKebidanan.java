...
public class RMDataCatatanObservasiRanapKebidanan extends javax.swing.JDialog {
    ...
    public RMDataCatatanObservasiRanapKebidanan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "HR(x/menit)","RR(x/menit)","Suhu(°C)","SpO2(%)","Kontraksi/HIS","BJJ","PPV","VT","NIP","Keterangan","Nama Petugas"
        }){
    ...
    private void initComponents() {
        ...
        jLabel31.setText("Ket:");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(780, 100, 40, 23);
        ...
        Keterangan.setBounds(830, 100, 209, 23);

        jLabel32.setText("VT :");
        jLabel32.setName("jLabel32"); // NOI18N
        FormInput.add(jLabel32);
        jLabel32.setBounds(536, 100, 40, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().isEmpty()||TPasien.getText().trim().isEmpty()){
            ...
            if(Sequel.menyimpantf("catatan_observasi_ranap_kebidanan","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",15,new String[]{
                ...
                TD.getText(),HR.getText(),RR.getText(),Suhu.getText(),SPO.getText(),Kontraksi.getText(),BJJ.getText(),PPV.getText(),VT.getText(),NIP.getText(),Keterangan.getText()
            })==true){
                tabMode.addRow(new String[]{
                    ...
                    VT.getText(),NIP.getText(),Keterangan.getText(),NamaPetugas.getText()
                });
    ...
    */
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("bjj"),rs.getString("ppv"),rs.getString("vt"),rs.getString("nip"),rs.getString("keterangan"),rs.getString("nama")
                    });
                }
            } catch (Exception e) {
    ...
    private void ganti() {
        if(Sequel.mengedittf("catatan_observasi_ranap_kebidanan","tgl_perawatan=? and jam_rawat=? and no_rawat=?","no_rawat=?,tgl_perawatan=?,jam_rawat=?,gcs=?,td=?,"+
            "hr=?,rr=?,suhu=?,spo2=?,kontraksi=?,bjj=?,ppv=?,vt=?,nip=?,keterangan=?",18,new String[]{
            TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+""),Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),GCS.getText(),
