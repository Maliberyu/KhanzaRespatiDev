...
public class DlgRekapObatPasien extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        status.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Obat Rawat Jalan", " " }));
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    */
    ...
    psreg=koneksi.prepareStatement(
        ...
        "left join resume_pasien on reg_periksa.no_rawat=resume_pasien.no_rawat "+
...
//            }
            ...
            try {
                if((status.getSelectedIndex()==0)&&nmpenjab.getText().isEmpty()&&TCari.getText().isEmpty()){
                    ...
                    psreg.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                    psreg.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                    psreg.setString(3,"%"+status.getSelectedItem().toString().replaceAll("Obat Rawat Jalan","Ralan").replaceAll
                    ("Obat Rawat Inap","Ranap").replaceAll("Semua Status","")
                            +"%");
