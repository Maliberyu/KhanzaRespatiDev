...
public class DlgPermintaanStokPasien extends javax.swing.JDialog {
    ...
    private String norawatibu,tampilkan_ppnobat_ranap="",aktifkanbatch="no",kelas="",bangsal="",kamar="",hppfarmasi="",penjab="",status="";
    ...
    private void initComponents() {
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-08-2024" }));
...
//            Jeniskelas.setSelectedItem("VVIP");        
//        } 
//        kenaikan=Sequel.cariIsiAngka2("select (hargajual/100) from  set_harga_obat_ranap where kd_pj=? and kelas=?",KdPj.getText(),kelas);        TCari.requestFocus();
