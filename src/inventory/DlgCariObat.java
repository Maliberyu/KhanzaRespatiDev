...
public final class DlgCariObat extends javax.swing.JDialog {
    ...
    private ResultSet rs,rsobat,carikapasitas,rsstok,rs2,rsbatch,rsrekening,rsracikan;
    ...
    private String signa1="1",signa2="1",nokunjungan="",kdObatSK="",requestJson="",URL="",otorisasi,sql="",aktifpcare="no",no_batchcari="", tgl_kadaluarsacari="", no_fakturcari="", aktifkanbatch="no",kodedokter="",namadokter="",noresep="",bangsal="",bangsaldefault=Sequel.cariIsi("select set_lokasi.kd_bangsal from set_lokasi limit 1"),tampilkan_ppnobat_ralan="",
                   Suspen_Piutang_Obat_Ralan="",Obat_Ralan="",HPP_Obat_Rawat_Jalan="",Persediaan_Obat_Rawat_Jalan="",hppfarmasi="",VALIDASIULANGBERIOBAT="",DEPOAKTIFOBAT="",utc="",rincianobat="",finger="",kelas="";
    ...
    private void initComponents() {
        ...
        Jeniskelas.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Rawat Jalan", "Utama/BPJS", "Beli Luar", "Karyawan" }));
    ...
    */
    ...
    private void hitungObat() {
        ...
        if(tampilkan_ppnobat_ralan.equals("Yes")){
            //modif ppn resep validasi resep rajal
            ppnobat=Math.round(ttl*0.0);
            //
            ttl=ttl+ppnobat;
                ...
                try{  
                    ...
                    try{
                        ...
                        if(rs.next()){
                            ...
                            param.put("propinsirs",akses.getpropinsirs());
 //modif cetak resep sebelum validasi
                          //  param.put("tanggal",Valid.SetTgl(rs.getString("tgl_peresepan")+""));
                           ...
                           param.put("tanggal",Tanggal.getText());
                            ...
                            // param.put("tgl_lahir",rs.getString("nm_pasien"));
                            ...
                            param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
                            Valid.MyReportqry("rptDaftarResepSebelumVal.jasper","report","::[ Resep Sebelum Validasi ]::","select * from temporary_resep where temporary_resep.temp37='"+akses.getalamatip()+"' order by temporary_resep.no",param);
                            this.setCursor(Cursor.getDefaultCursor());
                        }          
                    } catch(Exception ex){
                        System.out.println("Notifikasi : "+ex);
