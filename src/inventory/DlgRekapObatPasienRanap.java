...
public class DlgRekapObatPasienRanap extends javax.swing.JDialog {
    private final DefaultTableModel tabMode,tabMode2;
    private sekuel Sequel=new sekuel();
    private validasi Valid=new validasi();
    private Connection koneksi=koneksiDB.condb();
    private PreparedStatement psobat,psreg,pskamar;
    private ResultSet rsobat,rsreg,rskamar,rsdiagnosa; 
     ...
     * @param parent
     * @param modal */
    public DlgRekapObatPasienRanap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        tabMode=new DefaultTableModel(null,new Object[]{"No.","Tanggal","No.RM","Nama Pasien","Jml","Nama Obat","Biaya Obat","Embalase","Tuslah","Total","Diagnosa"}){
    ...
    private void initComponents() {
        ...
        status.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Obat Rawat Inap", " " }));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRekapObatPasienRanap dialog = new DlgRekapObatPasienRanap(new javax.swing.JFrame(), true);
    ...
    psreg=koneksi.prepareStatement(
        "select reg_periksa.tgl_registrasi,reg_periksa.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,resume_pasien_ranap.diagnosa_utama "+
        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
       
                "left join resume_pasien_ranap on reg_periksa.no_rawat=resume_pasien_ranap.no_rawat "+
...
//            if((status.getSelectedIndex()==0)&&nmpenjab.getText().isEmpty()&&TCari.getText().isEmpty()){
//                psreg=koneksi.prepareStatement(
//                    "select reg_periksa.tgl_registrasi,reg_periksa.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,resume_pasien.diagnosa_utama "+
//                   "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
//                   "where reg_periksa.stts<>'Batal' and reg_periksa.tgl_registrasi between ? and ? order by reg_periksa.tgl_registrasi");
//            }else{
//                psreg=koneksi.prepareStatement(
                    ...
                    try {
                        ...
                        if(rsobat.next()){
                             ...
                             while(rsobat.next()){
                                ...
                                rsreg.getString("diagnosa_utama")                                  });
//                                    tabMode.addRow(new String[]{
