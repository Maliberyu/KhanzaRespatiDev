...
public class DlgPemberianDiet extends javax.swing.JDialog {
    ...
    public DlgPemberianDiet(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                "No.Rawat","Nama Pasien","Kamar","Tanggal","Waktu","Jam","Diet","Diagnosa","Kode Kamar","Kode Diet","Tanggal Lahir"
            }){
    ...
    public void tampil() {   
        try{
            ...
            ps=koneksi.prepareStatement(
                ...
                "detail_beri_diet.tanggal,detail_beri_diet.waktu,jam_diet_pasien.jam,diet.nama_diet,detail_beri_diet.kd_kamar,detail_beri_diet.kd_diet,pasien.tgl_lahir " +
                "from detail_beri_diet inner join reg_periksa on detail_beri_diet.no_rawat=reg_periksa.no_rawat "+
                "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join diet on detail_beri_diet.kd_diet=diet.kd_diet "+
                "inner join kamar on detail_beri_diet.kd_kamar=kamar.kd_kamar "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("kd_kamar"),rs.getString("kd_diet"),rs.getString("tgl_lahir")
                    });
                }
            } catch (Exception e) {
