...
import bridging.*;
import aihelper.*;
import aihelper.FormTanyaAI;
import aihelper.AIHelper;
...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel4.setBounds(0, 190, 90, 23);

        jLabel16.setText("Berat (Kg) :");
        jLabel16.setName("jLabel16"); // NOI18N
        panelGlass12.add(jLabel16);
        jLabel16.setBounds(280, 160, 79, 23);
        ...
        jLabel17.setBounds(130, 160, 70, 23);
        ...
        TTinggi.setBounds(210, 160, 60, 23);
        ...
        Jabatan.setBounds(190, 40, 210, 23);
        ...
        Btn5Soap.setBounds(400, 40, 28, 23);
        ...
        BtnTemplatePemeriksaan.setBounds(430, 40, 28, 23);
        ...
        BtnResepObat1.setBounds(960, 40, 110, 23);
        ...
        BtnRiwayat1.setBounds(960, 70, 120, 23);

        BtnIcare.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/accept_page.png"))); // NOI18N
        BtnIcare.setText("ICARE BPJS");
        BtnIcare.setFocusPainted(false);
        ...
        BtnIcare.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnIcare.setName("BtnIcare"); // NOI18N
        BtnIcare.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnIcare.setRoundRect(false);
        ...
        BtnIcare.setBounds(960, 100, 120, 23);
        ...
        BtnChatGemini.setBounds(960, 140, 160, 30);
        ...
        jLabel58.setText("Umur:");
        jLabel58.setName("jLabel58"); // NOI18N
        FormInput.add(jLabel58);
        jLabel58.setBounds(690, 70, 40, 20);
        ...
        jLabel59.setBounds(930, 10, 40, 20);
        ...
        jLabel61.setText("Tanggal Lahir:");
        jLabel61.setName("jLabel61"); // NOI18N
        FormInput.add(jLabel61);
        jLabel61.setBounds(1100, 10, 90, 20);
...
//         if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
//            Sequel.cariIsi("select dokter.nama from dokter where dokter.nik=?",TDokter,KdDok.getText());
//        }else if(evt.getKeyCode()==KeyEvent.VK_UP){
...
//            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
//            tabModePemeriksaan.requestFocus();
//        }else{
//            if(tabModePemeriksaan.getSelectedRow()!= -1){
//                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
...
//        }
    ...
    */
    ...
    public void setNoRm(String norwt,Date tgl1,Date tgl2) {
        ...
        isRawat();
        isPsien();  
        //matikan garis dibawah untuk memunculkan user yang login di soap
...
//            tinggi += 24;
        ...
        if(akses.getjml2()>=1){
            ...
            TPerawat.setText(dokter.tampil3(kdptg.getText()));
            KdPeg2.setText(akses.getkode());
            TPegawai2.setText(dokter.tampil3(KdPeg2.getText()));
            Sequel.cariIsi("select pegawai.jbtn from pegawai where pegawai.nik=?",Jabatan1,KdPeg2.getText());
            //modif tampil tampil dokter di soap
//          
