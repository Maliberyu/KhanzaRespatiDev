...
// batas input karakter
        ...
        TTinggi.setDocument(new batasInput((byte)8).getKata(TTinggi));
    ...
    private void initComponents() {
        ...
        BtnInputJadwalOP2 = new widget.Button();
        BtnVerifikasiSOAP = new widget.Button();
        BtnChatGemini = new widget.Button();
        ...
        BtnVerifikasiSBAR1 = new widget.Button();
        ...
        jLabel17.setBounds(10, 190, 70, 23);

        jLabel63.setText("Tensi (mmHg) :");
        ...
        BtnGrafikTTV.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/RerunQualityControl.png"))); // NOI18N
        ...
        BtnGrafikTTV.setBounds(960, 10, 28, 23);
        ...
        jLabel66.setBounds(990, 10, 80, 23);
        ...
        BtnResepObat1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Vial-Pills.png"))); // NOI18N
        BtnResepObat1.setText("Input Resep");
        BtnResepObat1.setFocusPainted(false);
        BtnResepObat1.setFocusable(false);
        ...
        BtnResepObat1.setBounds(960, 30, 190, 30);

        BtnRiwayat1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/2.png"))); // NOI18N
        ...
        BtnRiwayat1.setBounds(960, 60, 210, 40);
        ...
        TTinggi.setBounds(220, 160, 60, 23);
        ...
        BtnInputJadwalOP2.setForeground(new java.awt.Color(0, 0, 0));
        BtnInputJadwalOP2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Hospital.png"))); // NOI18N
        BtnInputJadwalOP2.setMnemonic('4');
        BtnInputJadwalOP2.setText("Status Verifikasi SOAP");
        BtnInputJadwalOP2.setToolTipText("");
        BtnInputJadwalOP2.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnInputJadwalOP2.setGlassColor(new java.awt.Color(51, 153, 255));
        BtnInputJadwalOP2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnInputJadwalOP2.setName("BtnInputJadwalOP2"); // NOI18N
        BtnInputJadwalOP2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnInputJadwalOP2ActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnInputJadwalOP2);
        BtnInputJadwalOP2.setBounds(950, 140, 160, 30);

        BtnVerifikasiSOAP.setForeground(new java.awt.Color(0, 0, 0));
        BtnVerifikasiSOAP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/report24.png"))); // NOI18N
        BtnVerifikasiSOAP.setMnemonic('4');
        BtnVerifikasiSOAP.setText("Verifikasi SOAP");
        BtnVerifikasiSOAP.setToolTipText("");
        BtnVerifikasiSOAP.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnVerifikasiSOAP.setGlassColor(new java.awt.Color(51, 153, 255));
        ...
        BtnVerifikasiSOAP.setBounds(950, 100, 160, 30);

        BtnChatGemini.setForeground(new java.awt.Color(0, 0, 0));
        BtnChatGemini.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/New.png"))); // NOI18N
        BtnChatGemini.setMnemonic('4');
        BtnChatGemini.setText("Tanya AI");
        BtnChatGemini.setToolTipText("");
        BtnChatGemini.setGlassColor(new java.awt.Color(51, 153, 255));
        BtnChatGemini.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnChatGemini.setName("BtnChatGemini"); // NOI18N
        BtnChatGemini.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnChatGeminiActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnChatGemini);
        BtnChatGemini.setBounds(950, 180, 160, 30);
        ...
        BtnVerifSbar.setBounds(940, 110, 28, 23);
        ...
        jLabel84.setBounds(980, 110, 140, 23);
        ...
        BtnVerifikasiSBAR1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/accept_page.png"))); // NOI18N
        BtnVerifikasiSBAR1.setText("Verifikasi SBAR Dokter");
        BtnVerifikasiSBAR1.setFocusPainted(false);
        BtnVerifikasiSBAR1.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnVerifikasiSBAR1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnVerifikasiSBAR1.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnVerifikasiSBAR1.setMaximumSize(new java.awt.Dimension(98, 18));
        BtnVerifikasiSBAR1.setMinimumSize(new java.awt.Dimension(98, 18));
        BtnVerifikasiSBAR1.setName("BtnVerifikasiSBAR1"); // NOI18N
        BtnVerifikasiSBAR1.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnVerifikasiSBAR1.setRoundRect(false);
        BtnVerifikasiSBAR1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnVerifikasiSBAR1ActionPerformed(evt);
            }
        });
        panelGlass16.add(BtnVerifikasiSBAR1);
        BtnVerifikasiSBAR1.setBounds(940, 70, 170, 23);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-05-2025" }));
        ...
        TglLahir.setBounds(1200, 10, 100, 23);

        jLabel69.setText("Tanggal Lahir:");
        jLabel69.setName("jLabel69"); // NOI18N
        FormInput.add(jLabel69);
        jLabel69.setBounds(1100, 10, 90, 20);

        TUmur.setEditable(false);
        TUmur.setHighlighter(null);
        TUmur.setName("TUmur"); // NOI18N
        FormInput.add(TUmur);
        TUmur.setBounds(980, 10, 130, 23);

        jLabel85.setText("Umur:");
        jLabel85.setName("jLabel85"); // NOI18N
        FormInput.add(jLabel85);
        jLabel85.setBounds(930, 10, 40, 20);
            ...
            switch (TabRawat.getSelectedIndex()) {
                ...
                case 3:
                    if((!TKeluhan.getText().trim().isEmpty())||(!TPemeriksaan.getText().trim().isEmpty())||(!TSuhu.getText().trim().isEmpty())||
                            (!TTinggi.getText().trim().isEmpty())||(!TAlergi.getText().trim().isEmpty())||(!TTensi.getText().trim().isEmpty())||
                        ...
                        if(KdPeg.getText().trim().isEmpty()||TPegawai.getText().trim().isEmpty()){
                            ...
                            if(akses.getkode().equals("Admin Utama")){
                                if(Sequel.menyimpantf("pemeriksaan_ranap","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",20,new String[]{
                                        ...
                                        TSuhu.getText(),TTinggi.getText(),TNadi.getText(),TRespirasi.getText(),TTensi.getText(),TBerat.getText(),SpO2.getText(),TGCS.getText(),
                                    ...
                                    tabModePemeriksaan.addRow(new Object[]{
                                        ...
                                        TSuhu.getText(),TTinggi.getText(),TNadi.getText(),TRespirasi.getText(),TTensi.getText(),TBerat.getText(),SpO2.getText(),TGCS.getText(),cmbKesadaran.getSelectedItem().toString(),
                        ...
                        if(tbPemeriksaan.getSelectedRow()>-1){
                            if(akses.getkode().equals("Admin Utama")){
                                if(Sequel.mengedittf("pemeriksaan_ranap","no_rawat='"+tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),1)+
                                    ...
                                    tbPemeriksaan.setValueAt(TTinggi.getText(),tbPemeriksaan.getSelectedRow(), 7);
                                    ...
                                    tbPemeriksaan.setValueAt(TTensi.getText(),tbPemeriksaan.getSelectedRow(), 10);
...
//        pegawai.setVisible(true);
    ...
    private void btnTindakan3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTindakan3ActionPerformed
        if(TNoRw.getText().trim().isEmpty()||TPasien.getText().trim().isEmpty()){
            ...
            if(Sequel.cariRegistrasi(TNoRw.getText())>0){
                ...
                perawatan2.setPetugas(KdDok.getText(),TDokter.getText(),TSuhu.getText(),TTinggi.getText(),TKeluhan.getText(),TPemeriksaan.getText(),"","",
                    TBerat.getText(),TTensi.getText(),TNadi.getText(),TRespirasi.getText(),TGCS.getText(),TAlergi.getText());
                akses.setform("DlgRawatInap");
                perawatan2.isCek();
                perawatan2.tampil2();
    ...
    private void btnTindakan5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTindakan5ActionPerformed
        if(TNoRw.getText().trim().isEmpty()||TPasien.getText().trim().isEmpty()){
            ...
            if(Sequel.cariRegistrasi(TNoRw.getText())>0){
                ...
                perawatan2.setPetugas(kdptg.getText(),TPerawat.getText(),TSuhu.getText(),TTinggi.getText(),TKeluhan.getText(),TPemeriksaan.getText(),"","",
                    TBerat.getText(),TTensi.getText(),TNadi.getText(),TRespirasi.getText(),TGCS.getText(),TAlergi.getText());
                akses.setform("DlgRawatInap");
                perawatan2.isCek();
                perawatan2.tampil2();
    ...
    private void btnTindakan7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTindakan7ActionPerformed
        if(TNoRw.getText().trim().isEmpty()||TPasien.getText().trim().isEmpty()){
            ...
            if(Sequel.cariRegistrasi(TNoRw.getText())>0){
                ...
                perawatan2.setPetugas(KdDok2.getText(),TDokter2.getText(),TSuhu.getText(),TTinggi.getText(),TKeluhan.getText(),TPemeriksaan.getText(),kdptg2.getText(),TPerawat2.getText(),
                    TBerat.getText(),TTensi.getText(),TNadi.getText(),TRespirasi.getText(),TGCS.getText(),TAlergi.getText());
                akses.setform("DlgRawatInap");
                perawatan2.isCek();
                perawatan2.tampil2();
    ...
    private void BtnResumeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnResumeActionPerformed
        if(TNoRw.getText().trim().isEmpty()){
            ...
            resume.setLocationRelativeTo(internalFrame1);
            resume.setNoRm(TNoRw.getText(),TNoRM.getText(),TPasien.getText(),DTPCari2.getDate());
            resume.tampil();
            resume.setVisible(true);
            this.setCursor(Cursor.getDefaultCursor());
        }
...
//            this.setCursor(Cursor.getDefaultCursor());
 if(TPasien.getText().trim().isEmpty()||TNoRw.getText().trim().isEmpty()){
  ...
  if(TNoRw.getText().trim().isEmpty()){
    ...
    private void BtnVerifikasiSBAR1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnVerifikasiSBAR1ActionPerformed
        // TODO add your handling code here:
         if(TPasien.getText().trim().isEmpty()||TNoRw.getText().trim().isEmpty()){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
    ...
    }//GEN-LAST:event_BtnVerifikasiSBAR1ActionPerformed

    private void BtnInputJadwalOP2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnInputJadwalOP2ActionPerformed
    ...
    }//GEN-LAST:event_BtnInputJadwalOP2ActionPerformed
    ...
    private void BtnChatGeminiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnChatGeminiActionPerformed
        // TODO add your handling code here:
         this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        ChatGemini gemini=new ChatGemini(null,false);
        gemini.setSize(gemini.getWidth()-20,PanelAccor.getHeight()+50);
        gemini.setLocationRelativeTo(BtnChatGemini);
        gemini.setResizable(true);
        gemini.setVisible(true);
        gemini.setAlwaysOnTop(true);;
        this.setCursor(Cursor.getDefaultCursor());
                                                 
    }//GEN-LAST:event_BtnChatGeminiActionPerformed
    ...
    */
    ...
    private widget.Button BtnChatGemini;
    ...
    private widget.Button BtnInputJadwalOP2;
    ...
    private widget.Button BtnVerifikasiSBAR1;
    ...
    private void isRawat(){
        Sequel.cariIsi("select reg_periksa.no_rkm_medis from reg_periksa where reg_periksa.no_rawat=? ",TNoRM,TNoRw.getText());
         ...
         //modif
        Sequel.cariIsi("select pasien.umur from reg_periksa inner join pasien "+
                    " on reg_periksa.no_rkm_medis=pasien.no_rkm_medis where no_rawat=? ",TUmur,TNoRw.getText());
...
// modif di ats memunculkan yang login di pemeriksaan dokter
    ...
    public void isCek(){
        ...
        if(akses.getjml2()>=1){
            ...
            //modif di bawah memunculkan yang login di pemeriksaan dokter
            KdDok.setText(akses.getkode());
            TDokter.setText(pegawai.tampil3(KdDok.getText()));
            
           KdDok2.setText(akses.getkode());
           TDokter2.setText(pegawai.tampil3(KdDok.getText()));
            //
        }
    }
    ...
    private void getDataPemeriksaan() {
        if(tbPemeriksaan.getSelectedRow()!= -1){
            ...
            TTinggi.setText(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),7).toString()); 
