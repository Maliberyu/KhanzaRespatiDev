...
public class DlgRujuk extends javax.swing.JDialog {
    ...
    public DlgRujuk(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={
            ...
            "Keterangan Diagnosa","Kode Dokter","Dokter Perujuk","Kategori Rujuk","Ambulance","Keterangan","Kondisi","Pengobatan","Alasan Dirujuk","Terapi","Tindakan",
        };
        ...
        ket.setDocument(new batasInput((int)5000).getKata(ket));
         kondisi.setDocument(new batasInput((int)5000).getKata(kondisi));
          pengobatan.setDocument(new batasInput((int)5000).getKata(pengobatan));
           alasan.setDocument(new batasInput((int)5000).getKata(alasan));
    ...
    private void initComponents() {
        ...
        DTPRujuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-06-2025" }));
        ...
        ambulance.setBounds(510, 130, 60, 23);
        ...
        ktrujuk.setBounds(510, 100, 60, 23);
        ...
        jLabel17.setText(" Alasan :");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(630, 100, 90, 23);

        kondisi.setHighlighter(null);
        ...
        kondisi.setBounds(520, 70, 120, 23);

        pengobatan.setHighlighter(null);
        ...
        pengobatan.setBounds(730, 70, 170, 23);
        ...
        alasan.setBounds(730, 100, 170, 23);

        jLabel18.setText(" Keterangan/Kebutuhan :");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(570, 130, 150, 23);

        jLabel20.setText("Kondisi Terakhir :");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(420, 70, 90, 23);

        jLabel22.setText("Tindakan :");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(880, 100, 90, 23);
        ...
        tindakan.setBounds(980, 100, 170, 23);
        ...
        terapi.setBounds(980, 70, 170, 23);

        jLabel23.setText("Pengobatan :");
        ...
        jLabel24.setBounds(880, 70, 90, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRj.getText().trim().isEmpty()){
           ...
           if(Sequel.menyimpantf("rujuk","'"+TNoRj.getText()+"','"+TNoRw.getText()+"','"+TTmpRujuk.getText()+"','"+Valid.SetTgl(DTPRujuk.getSelectedItem()+"")+"',"+
                    "'"+TDiagnosa.getText()+"','"+KdDok.getText()+"','"+ktrujuk.getSelectedItem()+"','"+ambulance.getSelectedItem()+"','"+ket.getText()+"','"+kondisi.getText()+"','"+pengobatan.getText()+"','"+alasan.getText()+"','"+terapi.getText()+"','"+tindakan.getText()+"','"+
                ...
                tabMode.addRow(new String[]{
                    ...
                    TDokter.getText(),ktrujuk.getSelectedItem().toString(),ambulance.getSelectedItem().toString(),ket.getText(),kondisi.getText(),pengobatan.getText(),alasan.getText(),terapi.getText(),tindakan.getText()
                });
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TNoRj.getText().trim().isEmpty()){
            ...
            if(Valid.editTabletf(tabMode,"rujuk","no_rujuk",TNoRj,"no_rawat='"+TNoRw.getText()+"',rujuk_ke='"+TTmpRujuk.getText()+"',tgl_rujuk='"+Valid.SetTgl(DTPRujuk.getSelectedItem()+"")+"',"+
                    ...
                    "kat_rujuk='"+ktrujuk.getSelectedItem().toString()+"',ambulance='"+ambulance.getSelectedItem().toString()+"',keterangan='"+ket.getText()+"',kondisi='"+kondisi.getText()+"',pengobatan='"+pengobatan.getText()+"',alasan='"+alasan.getText()+"',terapi='"+terapi.getText()+"',tindakan='"+tindakan.getText()+"'")==true)
            {
                if(tbObat.getSelectedRow()!= -1){
                    ...
                    tbObat.setValueAt(kondisi.getText(),tbObat.getSelectedRow(),13);
                    tbObat.setValueAt(pengobatan.getText(),tbObat.getSelectedRow(),14);
                    tbObat.setValueAt(alasan.getText(),tbObat.getSelectedRow(),15);
                    tbObat.setValueAt(terapi.getText(),tbObat.getSelectedRow(),16);
                    tbObat.setValueAt(tindakan.getText(),tbObat.getSelectedRow(),17);
                    emptTeks();
                }
            }
        }
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptRujuk.jasper","report","::[ Data Rujuk Pasien ]::","select rujuk.no_rujuk,rujuk.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                "rujuk.rujuk_ke,rujuk.tgl_rujuk,rujuk.jam,rujuk.keterangan_diagnosa,rujuk.kd_dokter,dokter.nm_dokter,rujuk.kat_rujuk,rujuk.ambulance,rujuk.keterangan,rujuk.kondisi,rujuk.pengobatan,rujuk.alasan "+
...
//            param.put("terpi",diagnosa);
    ...
    "INNER JOIN rujuk ON reg_periksa.no_rawat = rujuk.no_rawat " +
...
//                "select rujuk.rujuk_ke,rujuk.no_rujuk,rujuk.keterangan,rujuk.kondisi,rujuk.pengobatan,rujuk.alasan,reg_periksa.no_rawat,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat,dokter.nm_dokter, "+
...
//                "and reg_periksa.no_rawat=rujuk.no_rawat and rujuk.kd_dokter=dokter.kd_dokter and where reg_periksa.no_rawat='"+TNoRw.getText()+"'",param);
            this.setCursor(Cursor.getDefaultCursor());
        }
    ...
    */
    ...
    private widget.TextBox pengobatan;
        ...
        try{
            ...
            sql="select rujuk.no_rujuk,rujuk.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                "rujuk.rujuk_ke,rujuk.tgl_rujuk,rujuk.jam,rujuk.keterangan_diagnosa,rujuk.kd_dokter,"
                    ...
                    + "rujuk.kondisi,rujuk.pengobatan ,rujuk.alasan,rujuk.terapi,rujuk.pengobatan   "+
                "from rujuk inner join reg_periksa inner join pasien inner join dokter "+
                "on rujuk.no_rawat=reg_periksa.no_rawat "+
                "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "and rujuk.kd_dokter=dokter.kd_dokter "+
        ...
        if(tbObat.getSelectedRow()!= -1){
            ...
            ket.setText(tbObat.getValueAt(tbObat.getSelectedRow(),12).toString());
             kondisi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),13).toString());
              pengobatan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),14).toString());
